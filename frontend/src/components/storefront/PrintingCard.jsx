        ...
        <div className="absolute top-2 sm:top-3 left-2 sm:left-3 right-2 sm:right-3 flex justify-between items-center gap-1.5 flex-wrap pointer-events-none">
          ...
          <div className="flex items-center gap-1">
            ...
            {(service.featured || service.isFeatured) && (
              <span className="badge badge-white text-[0.6rem] sm:text-[0.6875rem] px-1.5 py-0.5 sm:px-2 sm:py-1 flex items-center gap-0.5 whitespace-nowrap">
      ...
      <div className="p-3.5 sm:p-5 flex flex-col gap-2 flex-1">
        <div>
          ...
          <div className="mt-2 flex items-baseline gap-2 flex-wrap">
            ...
            <span className="text-[0.6rem] sm:text-[0.6875rem] text-[var(--text-muted)] font-mono">
